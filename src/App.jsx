...
/>    
  ...
  <div className="flex flex-nowrap flex gap-3 w-full md:w-auto md:justify-center md:gap-4">

    {/* BOTÓN PRINCIPAL */}
    <a
      href="#musica"
      className="flex-1 md:flex-none font-aventena px-5 py-4 md:px-8 md:py-4 rounded-full bg-[#f04d00] text-white text-lg md:text-lg shadow-[0_0_25px_rgba(240,77,0,0.6)] hover:shadow-[0_0_40px_rgba(240,77,0,0.8)] hover:bg-[#ff5a1f] transition-all duration-300 whitespace-nowrap"
    >
      Escúcha
    </a>
