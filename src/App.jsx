...
/>    
  ...
  <div className="flex flex-nowrap justify-center gap-3">
    ...
    <a
      href="#musica"
      className="font-aventena px-5 py-4 md:px-8 md:py-4 rounded-full bg-[#f04d00] text-white font-semibold text-sm md:text-base shadow-[0_0_25px_rgba(240,77,0,0.6)] hover:shadow-[0_0_40px_rgba(240,77,0,0.8)] hover:bg-[#ff5a1f] transition-all duration-300 whitespace-nowrap"
    >
      Escúcha
    </a>
